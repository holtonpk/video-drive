  ...
  return (
    <div className="relative z-10">
      <div className="flex w-full h-16  relative">
        <Link
          href="/dashboard"
          className="flex flex-row items-center text-primary px-4 hover:opacity-80 w-fit absolute left-0 top-1/2 -translate-y-1/2 "
        >
      ...
      {userData && clientInfo ? (
        <div className="container w-screen  flex flex-col z-[99] overflow-hidden h-[calc(100vh-128px)] ">
...
const IdeaRow = ({idea, userData}: {idea: Idea; userData: UserData[]}) => {
  ...
  return (
    <div className="flex items-center justify-between border p-4 bg-foreground/40 dark:bg-foreground/20 rounded-md relative">
      ...
      <div className="flex flex-col gap-4 w-full pr-20 ">
...
const EditorJsRender = ({script}: {script: OutputData}) => {
  ...
  return (
    <div
      ...
      className=" flex-grow overflow-scroll w-full  text-primary  editor-js-view flex flex-col gap-4 "
    />
  );
};
