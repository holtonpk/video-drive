import {Bolt, SmileDarkGreen} from "../../icons";
  ...
  return (
    <div className="w-full relative flex  justify-center">
      <div className="bg-white rounded-[30px]  max-w-[500px] w-full  max-h-[700px] h-full relative">
        ...
        <Bolt className="absolute top-[10%] right-0 translate-x-1/2  w-[100px] h-[100px] fill-theme-color1" />
        <SmileDarkGreen className="absolute bottom-[5%] left-0 -translate-x-1/2  w-[100px] h-[100px] fill-primary " />
      </div>
    </div>
  );
};
