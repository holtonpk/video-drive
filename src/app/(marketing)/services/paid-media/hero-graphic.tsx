import {Bolt, SmileDarkPink} from "../../icons";
  ...
  return (
    <div className="w-full relative flex  justify-center">
      <div className="bg-white rounded-[30px]  max-w-[500px] w-full  max-h-[700px] h-full relative">
        ...
        <div className="absolute bg-theme-color3 rounded-[30px] -right-10 top-[50%] max-w-[250px] w-full  max-h-[300px] h-full overflow-hidden">
          <img
        ...
        <Bolt className="absolute top-[10%] right-0 translate-x-1/2  w-[100px] h-[100px] fill-theme-color3" />
        <SmileDarkPink className="absolute bottom-[5%] left-0 -translate-x-1/2  w-[100px] h-[100px] fill-primary " />
      </div>
    </div>
  );
};
