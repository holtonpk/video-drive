      ...
      <div className="flex  w-full justify-between  md:px-16 relative py-4 overflow-hidden">
        ...
        <div className="flex gap-8 mx-auto md:mx-0 text-sm font1">
          <div className="flex w-fit gap-2 flex-col ">
            <h1 className="text-[#141516] font1-extra-bold">Whitespace</h1>
            <Link
              href="/#stats"
        ...
        <div className="absolute z-10  h-[100%]  md:left-0 bottom-0 -translate-x-1/3 md:-translate-x-0  ">
          <svg
          ...
          >
            <defs>
              ...
              >
                <circle cx="1" cy="1" r="1" fill="#141516" />
                <animateTransform
                  attributeType="XML"
